...
$query="SELECT video_url FROM videocollection,happy WHERE vid_id=video_id";
...
$query="SELECT music_url FROM musiccollection,happy WHERE mus_id=music_id";
...
$query="SELECT meme_url FROM memescollection,happy WHERE mem_id=meme_id";
