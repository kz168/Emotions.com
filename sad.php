...
$query="SELECT video_url FROM videocollection,sad WHERE vid_id=video_id";
...
$query="SELECT music_url FROM musiccollection,sad WHERE mus_id=music_id";
...
$query="SELECT meme_url FROM memescollection,sad WHERE mem_id=meme_id";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="sadstyle.css">
</head>
<body>
