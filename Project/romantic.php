<?php
    ...
    $query="SELECT video_url FROM videocollection,romantic WHERE vid_id=video_id";
    ...
    $row=mysqli_fetch_assoc($result);
    $url4=$row['video_url'];
    $query="SELECT music_url FROM musiccollection,romantic WHERE mus_id=music_id";
    $result=mysqli_query($db_handle,$query);
    $row=mysqli_fetch_assoc($result);
    $url5=$row['music_url'];
    $row=mysqli_fetch_assoc($result);
    ...
    $row=mysqli_fetch_assoc($result);
    $url8=$row['music_url'];
    $query="SELECT meme_url FROM memescollection,romantic WHERE mem_id=meme_id";
    $result=mysqli_query($db_handle,$query);
    $row=mysqli_fetch_assoc($result);
    $url9=$row['meme_url'];
    $row=mysqli_fetch_assoc($result);
...
<body>
	...
	<ul id="nav">
		...
		<li id="navli"><a href="home.php#contact">Contact</a></li>
		<li id="navli"><a href="home.php#about">About</a></li>
	</ul>
